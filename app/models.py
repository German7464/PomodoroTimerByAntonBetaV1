...
class TimerProfile:
    ...
    work_end_message: str = "notification.default.work_end"
    short_break_end_message: str = "notification.default.short_break_end"
    long_break_end_message: str = "notification.default.long_break_end"
    ...
    widget_type: str = "compact"
    widget_size: str = "small"
